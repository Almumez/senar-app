...
class ClientInvoicePrinter {
  static Future<void> printInvoice(BuildContext context, ClientOrderModel order) async {
    // قم بإنشاء وثيقة PDF
  ...
  static Future<Uint8List> _generateInvoicePdf(BuildContext context, ClientOrderModel order) async {
    // تحميل الخط العربي
  ...
  static pw.Widget _buildHeader(pw.ImageProvider logo, ClientOrderModel order, pw.Font ttf) {
    return pw.Container(
      ...
      child: pw.Column(
        children: [
          ...
          pw.Row(
            ...
            children: [
              pw.Text(
                'تاريخ: ${DateFormat('yyyy-MM-dd HH:mm').format(order.createdAt)}',
                textDirection: pw.TextDirection.rtl,
                style: pw.TextStyle(font: ttf, fontSize: 12),
              ),
              pw.Text(
  ...
  static pw.Widget _buildSimpleInfo(ClientOrderModel order, pw.Font ttf) {
    return pw.Container(
  ...
  static pw.Widget _buildPriceSummary(ClientOrderModel order, pw.Font ttf) {
    bool isMaintenanceOrSupply = order.type == 'maintenance' || order.type == 'supply';
          ...
          if (isMaintenanceOrSupply)
            pw.Row(
              ...
              children: [
                ...
                pw.Text(
                  '${order.checkFee} ${LocaleKeys.sar.tr()}',
                  style: pw.TextStyle(font: ttf, fontSize: 12),
                  textDirection: pw.TextDirection.rtl,
                ),
              ],
