...
Future<void> showPaymentBottomSheet({
  ...
  return showModalBottomSheet(
    ...
    // تعيين useSafeArea إلى true لتجنب تداخل لوحة المفاتيح
    useSafeArea: true,
...
class _PaymentBottomSheetState extends State<PaymentBottomSheet> {
  ...
  // متغير لتتبع حالة لوحة المفاتيح
  ...
  void initState() {
    ...
    // تخصيص ارتفاع البطاقة - زيادة الارتفاع لتناسب الشاشات الصغيرة
    cardStyle.cardHeight = 220;
  ...
  Widget build(BuildContext context) {
    ...
    // تحديد ارتفاع مناسب للمحتوى - زيادة النسبة لتناسب الشاشات الصغيرة
    final contentMaxHeight = availableHeight * 0.9; // 90% من الارتفاع المتاح
    
    return AnimatedPadding(
      // إضافة تأثير حركي لرفع الـ bottom sheet عند ظهور لوحة المفاتيح
      ...
      child: Container(
        ...
        padding: EdgeInsets.only(
          ...
          left: 16.w,
          right: 16.w,
          bottom: 16.h, // تثبيت المسافة السفلية بدلاً من استخدام viewInsets.bottom
        ),
        child: SingleChildScrollView(
          // تمكين التمرير التلقائي للوصول إلى الحقل الذي تم التركيز عليه
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        */
                        ...
                        Container(
                          // استخدام ارتفاع متجاوب بدلاً من ثابت - زيادة الارتفاع للشاشات الصغيرة
                          height: MediaQuery.of(context).size.height < 700 ? 220.h : 250.h,
                          decoration: BoxDecoration(
                        ...
                        // إضافة مساحة إضافية في الأسفل عند ظهور لوحة المفاتيح
                        if (isKeyboardVisible) SizedBox(height: keyboardHeight * 0.5),
                      ],
                    );
                  },
                ),
